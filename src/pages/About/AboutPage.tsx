    ...
    >
      <div
        ...
        className={`
            ...
            bg-gradient-to-bl from-md3-ref-secondary-secondary99 to-md3-ref-secondary-secondary80
            bg-contain bg-no-repeat bg-top
          `}
      >
        <Breadcrumbs data={["About"]} className="pl-4 w-full max-w-2xl md:max-w-3xl lg:max-w-5xl" />
        <section className="pl-4 flex flex-col h-[90vh] max-h-[900px] justify-center max-w-2xl md:max-w-3xl lg:max-w-5xl w-full">
            ...
            <div className="flex items-center">
              <div className="w-1/2">
                ...
                <p className="text-l mb-2">
                  ...
                  basics. I have compiled the most valuable and not overly complex cases to set up most of the features.
                </p>
                <p className="text-l mb-2">
                  It's not a minimal setup, but it provides sufficient setup for web-app development, including the most
                  recent updates in frontend technology.
                </p>
                <p className="text-l mb-2">
                ...
                <p className="text-l mb-2">
                  ...
                  <a
                    ...
                    className="relative top-[3px] text-md3-sys-light-secondary hover:text-md3-sys-light-secondary/70 hover:underline inline-flex items-center gap-1"
                  >
                    <FaGithubSquare />
                    repo
                  </a>
              ...
              <div className="w-1/2 pl-16">
                <img src="/assets/images/hand.png" className="h-64 w-full object-cover rounded-xl" alt="Layout Image" />
              </div>
            </div>
          </div>
        </section>
      ...
      >
        <div className="container mx-auto text-left">
          ...
          <div className="flex items-start gap-2">
            <div className="w-1/2 bg-md3-sys-light-secondary-container/40 text-md3-sys-light-on-secondary-container rounded-lg p-2">
